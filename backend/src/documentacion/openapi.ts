export const especificacionOpenApi = {
  ...
  paths: {
    ...
    "/api/movimientos": { get: { security: [{ portador: [] }], summary: "Listar movimientos", responses: { "200": { description: "Movimientos paginados" } } }, post: { security: [{ portador: [] }], summary: "Crear movimiento", responses: { "201": { description: "Movimiento creado" } } } },
